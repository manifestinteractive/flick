...
function touchstart(e){
	...
	if(!_intval && !_mask) {
		...
		_intval2 = setInterval(removeMask, 3000);
	}
...
function touchend(e){
	...
	if(_mask) _intval2 = setInterval(removeMask, 1500);
...
function loadMask(){
	...
	_intval = null;
	if(!_mask){
		$('#'+_target).prepend("<div id='touchMoveLayerMask' style='display: block; width: 100%; height: 100%; position: absolute; top: 0px; left: 0px; background-color: #000; opacity:.25;'>&nbsp;</div>");
		_mask = true;
	}
}
